...
public class AssemblyContigAlignmentSignatureClassifierUnitTest {
    ...
    public void testSignature(Tuple3<AlignmentInterval, AlignmentInterval, SAMSequenceDictionary> chimericPairsAndRefSeqDict,
        ...
        Assert.assertEquals(AssemblyContigAlignmentSignatureClassifier.isLikelySimpleTranslocation(region1, region2, expectedStrandSwitch), expectedIsLikelySimpleTranslocation);
        Assert.assertEquals(AssemblyContigAlignmentSignatureClassifier.isLikelyInvertedDuplication(region1, region2), expectedIsLikelyInvDup);
